...
class CarFilter(django_filters.FilterSet):
    ...
    year_of_issue_min = django_filters.NumberFilter(field_name='model__year_of_issue', lookup_expr='gt')
    year_of_issue_max = django_filters.NumberFilter(field_name='model__year_of_issue', lookup_expr='lt')
...
class ModelFilter(django_filters.FilterSet):
    ...
    year_of_issue_min = django_filters.NumberFilter(field_name='year_of_issue', lookup_expr='gt')
    year_of_issue_max = django_filters.NumberFilter(field_name='year_of_issue', lookup_expr='lt')
